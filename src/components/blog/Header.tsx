...
export const Header = () => {
  ...
  return (
    <HeaderWrapper className="container mx-auto px-3 py-4 flex items-baseline" colorScheme={colorScheme}>
      <h1 className="dark:text-neutral-50 text-4xl font-medium cursor-pointer select-none" onClick={handleTitleClick}>
        {siteMetadata?.title}
      </h1>
