...
import { Mermaid, FigureImage } from "@/components/post";
...
graph LR
    ...
    Origin
    Unauthorized
    Client --> Cloudfront --> Function -- Success --> Origin
    Function -- failure --> Unauthorized
```
</Mermaid>
...
graph LR
    ...
    Client --> CF
    CF -- Success --> ALB
    CF -- Failure --> Unauthorized
    Rule -- Success --> ECS
    Rule -- Failure --> Unauthorized
```
</Mermaid>
